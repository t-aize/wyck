...
community leaders responsible for enforcement, the repository maintainers, through the
private report form of this repository: open the **Security** tab, choose **Report a
vulnerability**, and say that it is a conduct report. If that is not available, open an issue
asking for a private way to make a conduct report, without any details. Do not describe the
incident in public.
