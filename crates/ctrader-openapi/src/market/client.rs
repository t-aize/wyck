...
impl MarketClient {
    ...
    /// [`crate::Event::Spot`] of each carries the latest price even when the market is closed; then
    ...
    /// [`crate::Event::Spot`] events. Needs a price subscription on the same symbol first.
    ///
    /// # Errors
    ///
    ...
    /// Follows the order book of some symbols ([`crate::Event::Depth`]). Not every broker offers it.
    ///
    /// # Errors
    ///
