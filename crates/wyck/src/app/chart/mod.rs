...
fn palette_for_chart(colors: &options::ChartColors) -> scene::Palette {
    ...
    base.up = color(crate::app::theme::chart_up());
    base.down = color(crate::app::theme::chart_down());
    base.line = color(crate::app::theme::chart_line());
    base.grid = color(crate::app::theme::chart_grid());
    base.text = color(crate::app::theme::chart_muted());
    base.text_strong = color(crate::app::theme::chart_fg());
    base.bg = color(crate::app::theme::chart_bg());
    base.tag = color(crate::app::theme::chart_tag());
    base.border = color(crate::app::theme::chart_border());
    base.crosshair = color(crate::app::theme::chart_crosshair());
    base.accent = color(crate::app::theme::accent());
    base.kagi_yang = base.up;
    base.kagi_yin = base.down;
    base.pnf_up = base.up;
    base.pnf_down = base.down;
    scene::Palette::for_chart_with_base(colors, base)
}
