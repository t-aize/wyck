...
//!
//! They name shapes, not a graphics library: [`super::super::paint`] turns them into gpui quads,
//! paths and text on screen, and [`super::super::raster`] into pixels for a picture of the chart.
...
pub fn with_alpha(color: gpui::Rgba, alpha: f32) -> Hsla {
    let mut hsla: Hsla = color.into();
    hsla.a = alpha;
    hsla
}

pub fn hsla(color: gpui::Rgba) -> Hsla {
    color.into()
}
