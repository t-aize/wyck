...
//!
//! ```no_run
//! use wyck::openapi::auth::{authorization_url, new_state, CallbackListener, OAuthClient, Scope};
//! use wyck::openapi::{ClientBuilder, ClientCredentials, Environment, Event};
