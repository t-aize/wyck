...
//! # async fn demo(tokens: wyck::openapi::auth::TokenSet) -> wyck::openapi::Result<()> {
...
//! `subscribe_depth`) rather than adopting the [`MarketClient`](crate::openapi::market::MarketClient)-style
...
use crate::openapi::auth::{OAuthClient, TokenSet};
