...
//! out ([`crate::openapi::OpenApiError::Timeout`]) or the connection drops while it is in flight
//! ([`crate::openapi::OpenApiError::Closed`]), the order may still have reached the server: the answer was
...
/// [`crate::openapi::AccountClient::trading`] and the [module docs](self) for the non-idempotency caveat.
#[derive(Debug, Clone)]
